    ...
    def append(self, data):
        ...
        try:
            with open(self.filepath, 'a', newline='') as f:
                ...
                # Flexible writing
                row = [
                    serializable_data.get("timestamp", datetime.now().isoformat()),
                    serializable_data.get("side", ""),
                    serializable_data.get("reason", ""),
                    json.dumps(serializable_data, default=str) # JSON serialize with fallback to str
                ]
                writer.writerow(row)
